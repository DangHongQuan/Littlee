            ...
            <div className='bg-custom'>
                <div className='container-custom' >
                    <svg xmlns="http://www.w3.org/2000/svg" className='svg-custom' width="1220" height="147" viewBox="0 0 1920 147" fill="none">
                        ...
                        <image href="/img/Tags.png" x="600" y="30" width="600" height="50" onClick={() => navigate("/")} />
                        <text x="1100" y="62" fill="white" font-size="24">Sự kiện</text>
                    ...
                    <div>
                        ...
                        <div style={{ position: 'absolute', top: 290, left: 780, color: 'white', fontSize: 24 }}>
                            <input className='input-home' type="text" style={{ width: 210 }} placeholder='Gói gia đình' />
                        ...
                        <div style={{ position: 'absolute', top: 340, left: 780, color: 'white', fontSize: 24 }}>
                            <input className='input-homee' type="text" style={{ width: 90 }} placeholder='số lượng vé' />
                        </div>
                        <div style={{ position: 'absolute', top: 340, left: 880, color: 'white', fontSize: 24 }}>
                            <input className='input-homee' type="text" style={{ width: 110 }} placeholder='Ngày sử dụng' />
                        ...
                        <div style={{ position: 'absolute', top: 504, left: 800, color: 'white', zIndex: 1 }} >
                            <a href='/aa'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="220" height="100" viewBox="0 0 368 61" fill="none">
                                    <path d="M356.305 60.8686H11.7132C5.24768 60.8686 0 54.676 0 47.0463V13.8222C0 6.19253 5.24768 0 11.7132 0H356.305C362.77 0 368.018 6.19253 368.018 13.8222V47.0675C368 54.676 362.77 60.8686 356.305 60.8686Z" fill="#FF000A" />
                                    <text x="130" y="40" style={{ fontSize: 40, fontFamily: 'iCiel Koni' }} fill="white">Đặt vé</text>
                                </svg>
                            </a>
